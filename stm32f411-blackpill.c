...
// TODO copied from f429i-disco. Grab the datasheet and control it

// Calculated with stm32cubemx
// HSI 25 MHz LSI 32.768 kHz
// Systemclock 100 MHz Systemclock Muxer PLLCLK
#define CONFIG_HSE_HZ	25000000
#define CONFIG_PLL_M	12
#define CONFIG_PLL_N	96
...
int main(void)
{
	...
	*SYSCFG_MEMRMP = SYSCFG_MEMRMP_SWP_FMC << 10;
	...
	gpio_set_usart(gpio_base, 'A', 15, 7);
	gpio_set_usart(gpio_base, 'B', 3, 7);
